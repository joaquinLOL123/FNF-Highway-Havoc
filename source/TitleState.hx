...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			// music.loadStream(Paths.music('Toothpaste'));
			// FlxG.sound.list.add(music);
			// music.play();

			if(FlxG.sound.music == null) {
				FlxG.sound.playMusic(Paths.music('Toothpaste'), 0);
		...
		logoSpr = new FlxSprite(0, FlxG.height * 0.4).loadGraphic(Paths.image('the poopshitters'));
		add(logoSpr);
		logoSpr.visible = false;
		logoSpr.scale.set(1.3, 1.3);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			switch (curBeat)
			{
				...
				// credTextShit.screenCenter();
				case 7:
					createCoolText(['mod made by'], -60);
				case 12:
					addMoreText('These guys', -60);
				...
				case 20:
				    deleteCoolText();
				case 21:
				    createCoolText(['What do i']);
				case 26:
				    addMoreText('put here');
				case 27:
					deleteCoolText();
				case 28:
